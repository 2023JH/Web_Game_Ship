...
function drawShip_s12() { 
    ...
    if(stype_s12===2){
        ctx.fillStyle = "red";
        ctx.fillRect(sx - 25, sy - 15, 10, 30);
    }
...
function createRocket_s12() {
    if (fire_s12) {
        // 기본일 때, 요구사항 1
        if (stype_s12 === 1) {
            arrRocket_s12.push({ x: sx - 50, y: sy - 2, rw: 5, rh: 4, c: "green", v: 7 });// 요구사항 6,7
        }

        // 2단계, 요구사항 1
        if (stype_s12 === 2) {
            arrRocket_s12.push({ x: sx - 25, y: sy + 11, rw: 5, rh: 4, c: "green", v: 7 });// 요구사항 6,7
            arrRocket_s12.push({ x: sx - 25, y: sy - 15, rw: 5, rh: 4, c: "green", v: 7 });// 요구사항 6,7
        }

        // 3단계, 요구사항 1
        if (stype_s12 === 3) {
            arrRocket_s12.push({ x: sx - 50, y: sy - 2, rw: 5, rh: 4, c: "green", v: 7 });// 요구사항 6,7
            arrRocket_s12.push({ x: sx - 10, y: sy - 20, rw: 5, rh: 4, c: "green", v: 7 });// 요구사항 6,7
            arrRocket_s12.push({ x: sx - 10, y: sy + 16, rw: 5, rh: 4, c: "green", v: 7 });// 요구사항 6,7
        }
        ...
        if (stype_s12 === 4) {
            ...
            arrRocket_s12.push({ x: sx - 10, y: sy - 20, rw: 5, rh: 4, c: "green", v: 7 });// 요구사항 6,7
            arrRocket_s12.push({ x: sx - 10, y: sy + 16, rw: 5, rh: 4, c: "green", v: 7 });// 요구사항 6,7
            arrRocket_s12.push({ x: sx , y: sy - 25, rw: 5, rh: 4, c: "green", v: 7 });// 요구사항 6,7
            arrRocket_s12.push({ x: sx , y: sy + 21, rw: 5, rh: 4, c: "green", v: 7 });// 요구사항 6,7
        }
    }
}
...
// Enemy
function creatEnemy_s12() {
    var x_s12, y_s12, wh_s12, c_s12, v_s12;

    x_s12 = vcanvas.width;
    y_s12 = Math.floor(Math.random() * vcanvas.width) + 1;
...
// Wall, 요구사항 5
function createWall_s12(){
    var wx_s12, wy_s12, wwh_s12, wc_s12, wv_s12;
    var i, j;

    wc_s12 = "#" + parseInt(Math.random() * 0xffffff, 10).toString(16);
    j = Math.floor(Math.random() * vcanvas.height);
    for(i=0;i<j;i+=1){
        wx_s12 = vcanvas.width;
        wy_s12 = 50 * i +5;
        wwh_s12 = 45;
        wv_s12 = 2.5;

        arrEnemy_s12.push({x:wx_s12, y:wy_s12, wh:wwh_s12, v:wv_s12, c:wc_s12});
    }
}
...
function init() {
    ...
    setInterval(createWall_s12, 15000)
