...
function createRocket() {
    if (fire) {
        if (stype === 1) {
            arrRocket.push({ x: sx - 50, y: sy - 2, rw: 5, rh: 4, c: "green", v: 7 });
        }

        if (stype === 2) {
            arrRocket.push({ x: sx - 25, y: sy + 11, rw: 5, rh: 4, c: "green", v: 7 });
            arrRocket.push({ x: sx - 25, y: sy - 15, rw: 5, rh: 4, c: "green", v: 7 });
        }

        if (stype === 3) {
            arrRocket.push({ x: sx - 50, y: sy - 2, rw: 5, rh: 4, c: "green", v: 7 });
            arrRocket.push({ x: sx - 10, y: sy - 20, rw: 5, rh: 4, c: "green", v: 7 });
            arrRocket.push({ x: sx - 10, y: sy + 16, rw: 5, rh: 4, c: "green", v: 7 });
        }
        ...
        if (stype === 4) {
            ...
            arrRocket.push({ x: sx - 10, y: sy - 20, rw: 5, rh: 4, c: "green", v: 7 });
            arrRocket.push({ x: sx - 10, y: sy + 16, rw: 5, rh: 4, c: "green", v: 7 });
            arrRocket.push({ x: sx, y: sy - 25, rw: 5, rh: 4, c: "green", v: 7 });
            arrRocket.push({ x: sx, y: sy + 21, rw: 5, rh: 4, c: "green", v: 7 });
        }
    }
}
...
function createEnemy() {
    ...
    x = vcanvas.width;
    y = Math.floor(Math.random() * vcanvas.width) + 1;
...
function createWall() {
    ...
    wc = "#" + parseInt(Math.random() * 0xffffff, 10).toString(16);
    ...
    for (i = 0; i < j; i += 1) {
        ...
        arrEnemy.push({ x: wx, y: wy, wh: wwh, v: wv, c: wc });
    }
}
